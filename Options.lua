...
caframe:SetBackdropColor(0, 0, 0)
...
function widgets:anchor(parent, config)
    ...
    frame.dropdown:SetPoint("LEFT", -20, 0)
    ...
    frame.checkbox1:SetPoint("LEFT", frame.dropdown.Label, "RIGHT", 0, 0)
    frame.checkbox2 = self:checkbox(frame, {keystring=config.keystring..".returnInCombat"})
    frame.checkbox2:SetPoint("LEFT", frame.checkbox1.Text, "RIGHT", 7, 0)
    frame.checkbox3 = self:checkbox(frame, {keystring=config.keystring..".returnOnUnitFrame"})
    frame.checkbox3:SetPoint("LEFT", frame.checkbox2.Text, "RIGHT", 15, 0)
    return frame
end
